...
import { loginSchema, refreshTokenSchema, registerSchema, sendOTPSchema, verifyOTPSchema } from "./auth.schema";
...
router.post("/refresh-token", schemaValidate(refreshTokenSchema), authController.refreshToken);
